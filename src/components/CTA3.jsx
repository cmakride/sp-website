  ...
  return ( 
    <div className="mt-10 w-full flex content-center justify-center bg-white">
      <div className="max-w-4xl w-7/10 p-10  py-20  flex  flex-col  flex-wrap  justify-center  content-center gap-3">
        <div className="m-0  p-0  font-main text-xl lg:text-2xl font-medium tracking-wider text-rosebrown-500 text-center">Ready to Activate Your True Potential?</div>
