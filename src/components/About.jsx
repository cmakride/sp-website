  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center overflow-hidden w-full gap-10 py-16 max-w-7xl'>
      ...
      <div className="max-w-2xl mx-10 lg:mx-0 flex flex-col items-center">
        <h2 className="font-main text-4xl font-medium tracking-wider text-rosebrown-300 ">Meet Bruna</h2>
        <p className="mt-6 font-main text-2xl font-light tracking-wider text-rosebrown-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum omnis voluptatem accusantium nemo perspiciatis delectus atque autem! Voluptatum tenetur beatae unde aperiam, repellat expedita consequatur! Officiis id consequatur atque doloremque!</p>
        <p className="mt-6 font-main text-2xl font-light tracking-wider text-rosebrown-500"> Nobis minus voluptatibus pariatur dignissimos libero quaerat iure expedita at? Asperiores nemo possimus nesciunt dicta veniam aspernatur quam mollitia.</p>
        <p className="mt-6 font-main text-2xl font-light tracking-wider text-rosebrown-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum omnis voluptatem accusantium nemo perspiciatis delectus atque autem! Voluptatum tenetur beatae unde aperiam, repellat expedita consequatur! Officiis id consequatur atque doloremque!</p>
